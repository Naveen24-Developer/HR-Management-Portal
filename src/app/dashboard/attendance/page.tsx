...
export default function AttendanceManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Attendance Table with NEW COLUMNS */}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>
                    • {Math.round((stats.presentToday / stats.totalEmployees) * 100)}% attendance rate this month
                  </li>
                  <li>
                    • {Math.round((stats.lateToday / stats.presentToday) * 100)}% of employees arrived late
                  </li>
                  <li>
                    • Average overtime: {stats.averageWorkHours > 8 ? (stats.averageWorkHours - 8).toFixed(1) : 0}h per day
                  </li>
                </ul>
              </div>
            </div>
